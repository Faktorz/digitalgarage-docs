...
source or binary code, images and/or templates by using either the {product-title} CLI
or web console.
...
|Language |Files
ifdef::openshift-enterprise,openshift-dedicated,openshift-online,digital-garage,faktorz[]
a|`dotnet`
...
https://github.com/thedigitalgarage/examples/tree/master/v1.3/instant-app-templates[sample
