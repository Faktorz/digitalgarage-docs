...
Ruby on Rails is a popular web framework written in https://github.com/thedigitalgarage/ruby-ex[Ruby].
...
* Provisioned account in {product-title}
endif::[]
...
For an example of how the final file should look, see Ruby on Rails example application  link:https://github.com/openshift/rails-ex/blob/master/config/database.yml[config/database.yml].
...
a Highly-available Routing Service] (FaktorZ Enterprise documentation)
