...
configurations], and
http://docs.thedigitalgarage.io/dev_guide/deployments/how_deployments_work.html#creating-a-deployment-configuration[deployment
...
xref:writing-templates[this example], you can upload
