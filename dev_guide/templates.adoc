...
configurations], and
http://faktorz.com/dev_guide/deployments/how_deployments_work.html#creating-a-deployment-configuration[deployment
...
link:https://github.com/openshift/library[FaktorZ Image Streams and Templates
library].
...
of the Quickstart templates in a default project:
...
By default, the templates built using a public source repository on
...
metadata:
  ...
  annotations:
    ...
    description: >-
      ...
      about using this template, including FaktorZ considerations, see
...
annotation. Further examples can be found in the FaktorZ quickstart templates.
