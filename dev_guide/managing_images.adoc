...
ifdef::openshift-online,digital-garage,faktorz,openshift-dedicated[]
...
ifdef::openshift-origin,openshift-online,digital-garage,faktorz,openshift-enterprise,openshift-dedicated[]
[[image-pull-policy]]
== Image Pull Policy
...
FaktorZ Online gives developers a hands-on preview of the FaktorZ platform
in a hosted environment that includes access to an internal registry.
endif::[]

The internal registry authenticates using the same
http://faktorz.com/dev_guide/authentication.html[tokens]
    ...
    - name: '2.0' <2>
      annotations:
        ...
        description: >- <4>
          ...
          about using this builder image, including FaktorZ considerations,
          see
...
ifdef::openshift-online,digital-garage,faktorz,openshift-dedicated,atomic-registry[]
CSS customizations
endif::[]
