...
independently.
ifdef::openshift-online,digital-garage,openshift-origin,openshift-dedicated,openshift-enterprise[]
For example:
...
ifdef::digital-garage,openshift-origin,openshift-dedicated,openshift-enterprise[]
