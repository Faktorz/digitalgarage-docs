...
FaktorZ version 2 (v2) and FaktorZ version 3 (v3) and how to migrate these
...
In FaktorZ version 2 (v2), there are build, deploy, post_deploy, and pre_build
...
FaktorZ version 3 (v3) also offers a
