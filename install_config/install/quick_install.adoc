...
=======
- xref:adding-nodes-or-reinstalling-quick[add nodes] to an existing cluster,
- xref:../../install_config/upgrading/index.adoc#install-config-upgrading-index[upgrade your cluster], or
- xref:adding-nodes-or-reinstalling-quick[reinstall] the OpenShift cluster
>>>>>>> openshift/online
completely.
endif::[]
...
<3> A valid version of your selected variant: `3.3`, `3.2`, or `3.1`. If not
specified, this defaults to the latest version for the specified variant.
...
<<<<<<< HEAD
xref:../../install_config/install/rpm_vs_containerized.adoc#install-config-install-rpm-vs-containerized[RPM vs Containerized] for more details.
=======
xref:../../install_config/install/rpm_vs_containerized.adoc#install-config-install-rpm-vs-containerized[RPM vs
...
All].
- Configure the automatically-deployed xref:../registry/index.adoc#install-config-registry-overview[integrated Docker registry].
- Configure the automatically-deployed xref:../router/index.adoc#install-config-router-overview[router].
endif::[]
