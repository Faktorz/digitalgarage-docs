...
Before installing OpenShift, you must first see the xref:../../install_config/install/prerequisites.adoc#install-config-install-prerequisites[Prerequisites] topic to
>>>>>>> openshift/online
...
=======
xref:../../architecture/additional_concepts/sdn.adoc#architecture-additional-concepts-sdn[OpenShift SDN]. This
...
=======
xref:../../architecture/additional_concepts/sdn.adoc#sdn-design-on-masters[OpenShift
>>>>>>> openshift/online
...
xref:../../install_config/install/quick_install.adoc#adding-nodes-or-reinstalling-quick[quick
...
====
+
See xref:advanced-host-variables[Configuring Host Variables] for more options.
