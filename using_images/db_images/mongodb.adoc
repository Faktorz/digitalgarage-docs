...
https://github.com/ç/mongodb-container/tree/master/2.4[2.4], https://github.com/thedigitalgarage/mongodb-container/tree/master/2.6[2.6], and https://github.com/thedigitalgarage/mongodb-container/tree/master/3.2[3.2] of MongoDB.

== Images

The Digital Garage uses the base CentOS 7 image for the Mongo DB images.

These images are available on Docker Hub:

----
$ docker pull thedigitalgarage/mongodb-24-centos7
$ docker pull thedigitalgarage/mongodb-26-centos7
$ docker pull thedigitalgarage/mongodb-32-centos7
----
...
ifdef::openshift-origin[]
    thedigitalgarage/mongodb-26-centos7
endif::[]
...
The MongoDB templates should have been registered in the default Digital Garage
...
You can find instructions for instantiating templates
xref:../../dev_guide/templates.adoc#dev-guide-templates[here].
