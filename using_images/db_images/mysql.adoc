...
The MySQL templates should have been registered in the default Digital Garage
...
https://github.com/thedigitalgarage/dg-mysql-container/tree/master/5.5/examples/replica[example
...
----
$ oc create -f \
    https://raw.githubusercontent.com/thedigitalgarage/dg-mysql-container/master/5.5/examples/replica/mysql_replica.json
----
====
...
causes {product-title} to start only one instance of the server. Multiple instances
