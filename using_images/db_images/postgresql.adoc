...
FaktorZ uses the base CentOS 7 image for the postgresql DB images.
...
The PostgreSQL templates have been registered in the default openshift project/namespace
