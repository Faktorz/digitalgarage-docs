...
You can find https://github.com/thedigitalgarage/examples/tree/master/image-streams[example] ImageStream definitions for all the provided {product-title} images.
...
MySQL database and/or scaling MySQL, see the xref:../../dev_guide/using_images/mysql.adoc [MySQL Image Guide].
====
