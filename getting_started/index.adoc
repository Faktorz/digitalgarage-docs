...
[IMPORTANT]
====
For the {product-title} Discovery offering, consult the
xref:../getting_started/devpreview_faq.adoc#getting-started-devpreview-faq[Developer Discovery FAQ] for details
