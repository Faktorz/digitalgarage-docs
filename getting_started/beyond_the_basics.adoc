...
initial walkthrough of {product-title}.
...
|https://github.com/thedigitalgarage/examples/tree/master/v1.3/quickstart-templates#quickstarts[Rails]
...
|https://github.com/thedigitalgarage/examples/tree/master/v1.3/quickstart-templates#quickstarts[Dancer]
...
* https://github.com/thedigitalgarage/examples/tree/master/v1.3/quickstart-templates#quickstarts[Jenkins]
