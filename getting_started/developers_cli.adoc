...
unfamiliar with the core concepts of {product-title}, you might want to
start by reading about the concepts behind {product-title}. {product-title} provides
out of the box a set of
...
- You must register for an account with the http://www.thedigitalgarage.io[{product-title}]
endif::[]
ifdef::openshift-enterprise,openshift-origin,openshift-dedicated[]
...
+
----
$ oc login https://apps.thedigitalgarage.io:8443 --token=<tokenID>
----
