...
xref:../dev_guide/templates.adoc#using-the-instantapp-templates[Instant App
templates] and xref:../using_images/s2i_images/index.adoc#using-images-s2i-images-index[builder images] that
conform to the current xref:../getting_started/devpreview_faq.adoc#getting-started-devpreview-faq[set of
considerations] for running in the {product-title} offering.
endif::[]
ifdef::openshift-enterprise,openshift-origin,openshift-dedicated[]
