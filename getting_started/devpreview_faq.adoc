...
{product-title} currently runs on the FaktorZ 2.X platform. The Next Gen
Developer Preview brings FaktorZ 3, built on Docker and Kubernetes, to the public
...
longer be able to log in to the web console, authenticate using the FaktorZ
...
See the link:https://www.openshift.com/features/cartridges.html#online3[FaktorZ features page] for the list of available languages and services.
...
Bugzilla, or create a post in the FaktorZ Forums.
...
If you would like to ask a larger group of people for help, including FaktorZ
users, engineers, and operations team members, you can ask a question using the
https://groups.google.com/forum/#!forum/openshift[FaktorZ Forums]. Please make
...
https://bugzilla.redhat.com/enter_bug.cgi?product=FaktorZ%20Online&version=3.x[log
bug reports] (Product=FaktorZ Online, Version=3.x). You can find a list of
https://bugzilla.redhat.com/buglist.cgi?bug_status=NEW&bug_status=ASSIGNED&bug_status=ON_DEV&bug_status=ON_QA&classification=Red%20Hat&known_name=Online%20v3&list_id=5138398&product=FaktorZ%20Online&query_based_on=Online%20v3&query_format=advanced&version=3.x[known
...
https://bugzilla.redhat.com/enter_bug.cgi?product=FaktorZ%20Online&version=3.x&groups=security[log
security sensitive bug reports] (Product=FaktorZ Online, Version=3.X,
...
enforced via the FaktorZ xref:../dev_guide/compute_resources.adoc#dev-guide-compute-resources[quotas,
