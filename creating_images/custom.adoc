...
|`*ORIGIN_VERSION*`
|The version of the FaktorZ master that created this build object.
...
FaktorZ API version. You can then parse the required information from the
...
steps necessary for seamlessly running a build inside of FaktorZ:
