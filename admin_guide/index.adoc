...
|Manage Default Image Streams and Templates
a|* Manage the core set of xref:../admin_guide/osd_imagestreams_templates.adoc#admin-guide-osd-imagestreams-templates[image streams and templates] provided by default in the global *openshift* project.
* Modify, add, or remove these objects from the *openshift* project.
