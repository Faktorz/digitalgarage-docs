...
syntax. You must xref:get_started_cli.adoc#basic-setup-and-login[setup and login] with the CLI before
you can perform these operations.

ifndef::openshift-online,digital-garage,faktorz[]

The developer CLI uses the `oc` command, and is used for project-level
operations. This differs from the xref:../cli_reference/admin_cli_operations.adoc#cli-reference-admin-cli-operations[administrator
...
ifdef::openshift-enterprise,openshift-online,digital-garage,openshift-dedicated[]
3.0.2.0
endif::[]
...
ifdef::openshift-enterprise,openshift-online,digital-garage,openshift-dedicated[]
3.0.1.0
endif::openshift-enterprise,openshift-online,digital-garage,openshift-dedicated[]
