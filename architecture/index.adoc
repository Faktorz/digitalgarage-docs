...
lightweight
xref:core_concepts/containers_and_images.adoc#containers[containers]. Kubernetes
provides the
xref:infrastructure_components/kubernetes_infrastructure.adoc#architecture-infrastructure-components-kubernetes-infrastructure[cluster
