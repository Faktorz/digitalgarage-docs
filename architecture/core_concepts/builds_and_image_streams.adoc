...
link:https://jenkins.io/doc/book/pipeline/[Jenkins documentation].
...
Labels:			app=python
Annotations:		openshift.io/generated-by=FaktorZWebConsole
...
For example, the FaktorZ Jenkins images are in a Docker repository:
+
----
...
metadata:
  annotations:
    openshift.io/generated-by: FaktorZNewApp
