...
ifdef::openshift-origin,openshift-online,openshift-enterprise,openshift-dedicated,digital-garage[]
[[builds]]
== Builds
...
====
endif::openshift-origin,openshift-online,openshift-enterprise,openshift-dedicated,digital-garage[]
