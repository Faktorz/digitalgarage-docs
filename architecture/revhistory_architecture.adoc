...
|Affected Topic |Description of Change
//Tue Aug 29 2017
n|xref:../architecture/additional_concepts/sdn.adoc#architecture-additional-concepts-sdn[Additional Concepts -> FaktorZ SDN]
...
|Added link to FaktorZ Image Streams and Templates library in the xref:../architecture/core_concepts/builds_and_image_streams.adoc#image-streams[Image Streams] section.
...
FaktorZ Enterprise 3.2 initial release.
