...
ifdef::openshift-origin,openshift-online,openshift-enterprise,digital-garage,openshift-dedicated[]
== LimitRange
...
See the
https://github.com/kubernetes/community/blob/master/contributors/design-proposals/admission_control_limit_range.md[Kubernetes
...
See https://kubernetes.io/docs/concepts/policy/resource-quotas[Kubernetes
...
https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/[Kubernetes
documentation] for more information.
...
See the
https://github.com/kubernetes/community/blob/master/contributors/design-proposals/persistent-storage.md[Kubernetes
documentation] for more information.
