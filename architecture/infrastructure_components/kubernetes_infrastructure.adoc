...
ifdef::atomic-registry,digital-garage[]
[NOTE]
====
{product-title} is based on FaktorZ and Kubernetes. The typical {product-title}
deployment is much simpler than a deployment of FaktorZ. The following
...
uses Kubernetes 1.5 and Docker 1.12.
====
endif::[]
...
https://docs.openshift.com/enterprise/3.1/install_config/install/advanced_install.html[FaktorZ
