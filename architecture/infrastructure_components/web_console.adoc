...
== Overview
endif::openshift-origin,openshift-online,digital-garage,openshift-enterprise,openshift-dedicated[]
...
image::dg_cli_help.png["Command Line Tools"]
...
endif::openshift-online,digital-garage,openshift-dedicated[]
...
image::3.7-project-overview.png["Web Console Project Overview"]
...
ifdef::openshift-enterprise,openshift-online,digital-garage,faktorz[]
[[web-console-statefulsets]]
== StatefulSets

ifndef::openshift-online,digital-garage,faktorz[]
`StatefulSet` was introduced as a
link:https://access.redhat.com/support/offerings/techpreview[Technology Preview]
feature in {product-title} 3.5 and remains in Technology Preview.
endif::[]
...
image::3.7-statefulsets.png[StatefulSets view in OpenShift]
endif::openshift-enterprise,openshift-online,digital-garage,faktorz[]
